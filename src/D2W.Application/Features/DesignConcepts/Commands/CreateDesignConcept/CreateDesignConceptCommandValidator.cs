...
public class CreateDesignConceptCommandValidator : AbstractValidator<CreateDesignConceptCommand>
{
    ...
    public CreateDesignConceptCommandValidator()
    {
        ...
        // RuleForEach(a => a.WindowMeasurementItems).SetValidator(new ReferenceItemForAddValidator());
    }

    #endregion Public Constructors
}

//public class ReferenceItemForAddValidator : AbstractValidator<WindowMeasurementsItemForAdd>
//{
//    #region Public Constructors
